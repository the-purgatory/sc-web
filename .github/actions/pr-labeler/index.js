module.exports = /******/ (function (modules, runtime) {
  ...
  /******/ {
      ...
      module.exports = {
        _args: [
          [
            ...
            '/Users/timon/Projects/personal/pr-labeler-action'
          ]
        ],
        ...
        _inBundle: false,
        _integrity:
          'sha512-ZxiZMaCuqBG/IsbgNRVfGwYsvBb5DjHuMGjJgOrinT+/b+1j1U7PiGyRkHDJdjTGA6N/PsMC2lP2ZybX9579iA==',
        ...
        _resolved:
          'https://registry.npmjs.org/@octokit/rest/-/rest-16.23.2.tgz',
        _spec: '16.23.2',
    ...
    /***/ 277: /***/ function (module, __unusedexports, __webpack_require__) {
      const Deprecation = __webpack_require__(832);
      const logOnce = __webpack_require__(969)((deprecation) =>
    ...
    /***/ 314: /***/ function (module) {
      module.exports = {
        ...
        _requiredBy: ['/@actions/github'],
        _resolved:
          'https://registry.npmjs.org/@octokit/graphql/-/graphql-2.1.0.tgz',
        _spec: '2.1.0',
        _where: '/Users/timon/Projects/personal/pr-labeler-action',
        author: { name: 'Gregor Martynus', url: 'https://github.com/gr2m' },
      ...
      function Octokit(plugins, options) {
        ...
        const api = {
          ...
          request: requestWithDefaults(
            hook,
            endpoint,
            parseClientOptions(options, log)
          )
        };
  ...
  this.result;*/
    ...
    /***/ 509: /***/ function (module) {
      module.exports = {
        ...
        _resolved:
          'https://registry.npmjs.org/@octokit/request/-/request-2.4.2.tgz',
        _spec: '2.4.2',
        _where: '/Users/timon/Projects/personal/pr-labeler-action',
        author: { name: 'Gregor Martynus', url: 'https://github.com/gr2m' },
        browser: {
          './lib/get-request-agent.js': false,
          './lib/request/get-buffer-response.js':
            './lib/request/get-buffer-response-browser.js'
        },
        bugs: { url: 'https://github.com/octokit/request.js/issues' },
        bundlesize: [
          { path: './dist/octokit-request.min.js.gz', maxSize: '5KB' }
        ],
        dependencies: {
    ...
    /***/ 523: /***/ function (module, __unusedexports, __webpack_require__) {
      ...
      function bindApi(hook, state, name) {
        var removeHookRef = bindable(removeHook, null).apply(
          null,
          name ? [state, null, name] : [state, null]
        );
        ...
        ['before', 'error', 'after', 'wrap'].forEach(function (kind) {
          ...
          hook.remove[kind] = hook.api.remove[kind] = bindable(
            removeHook,
            null
          ).apply(null, args);
        });
    ...
    /***/ 724: /***/ function (module) {
      module.exports = {
        ...
        _resolved:
          'https://registry.npmjs.org/@octokit/endpoint/-/endpoint-3.2.3.tgz',
        _spec: '3.2.3',
        _where: '/Users/timon/Projects/personal/pr-labeler-action',
        author: { name: 'Gregor Martynus', url: 'https://github.com/gr2m' },
        bugs: { url: 'https://github.com/octokit/endpoint.js/issues' },
        bundlesize: [
          { path: './dist/octokit-endpoint.min.js.gz', maxSize: '3.5KB' }
        ],
        dependencies: {
          deepmerge: '3.2.0',
          'is-plain-object': '^2.0.4',
    ...
    /***/ 742: /***/ function (module, __unusedexports, __webpack_require__) {
      ...
      function defaultOptions(defaults, route, options) {
        ...
        options.mediaType.previews = options.mediaType.previews.map((preview) =>
                ...
                if (
                  Array.isArray(patterns)
                    ? patterns.some((pattern) =>
                        matcher_1.default.isMatch(ref, pattern)
                      )
